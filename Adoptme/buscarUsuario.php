...
$conexion = new mysqli($server, $user, $pass, $db);
    ...
    $sql2="SELECT * from usuarios where Nombre like '$buscar' '%' or ApellidoP like '$buscar' '%' or ApellidoM like '$buscar' '%'  or Usuario like '$buscar' '%' or Correo like '$buscar' '%' or Contrasena like '$buscar' '%'   order by IdUsuario desc";
